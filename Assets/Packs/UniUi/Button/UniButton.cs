...
#pragma warning disable 0649
        ...
        [SerializeField] protected bool isStartGame;
        ...
        [SerializeField] private IMotion _motion;
        [SerializeField] private IMotion _motionDisable;
...
#pragma warning restore 0649
            ...
            PointerEventData eventData)
        {
            ...
            if (!isStartGame) AudioManager.Instance.PlayAudioButtonClick();
            else AudioManager.Instance.PlayAudioButtonClickStartGame();
            IsRelease = false;
            IsPrevent = false;
            if (!IsMotion) return;
