...
namespace Lance.Common
{
    ...
    public class Timer
    {
        ...
        private float GetWorldTime() { return this.UsesRealTime ? Time.realtimeSinceStartup : Time.time; }

        private float GetFireTime() { return this._startTime + this.Duration; }

        private float GetTimeDelta() { return this.GetWorldTime() - this._lastUpdateTime; }
        ...
        private class TimerManager : MonoBehaviour
        {
            ...
            public void RegisterTimer(Timer timer) { this._timersToAdd.Add(timer); }
