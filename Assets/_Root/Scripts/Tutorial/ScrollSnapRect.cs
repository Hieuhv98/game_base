...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    [Tooltip("Container with background images (optional)")]
    ...
    public Action ActionUpdatePage;
    void Awake()
    {
        ...
        // init
        Init((int)((GameData.CurrentRoom -1) / 3));
    ...
    private void LerpToPage(int aPageIndex)
    {
        ...
        backgroud.sprite = listSpriteBackground[aPageIndex];
        ...
        ActionUpdatePage?.Invoke();
    }

    void CheckPageButton() 
    {
        var prev = prevButton.GetComponentsInChildren<UniButton>();
        var next = nextButton.GetComponentsInChildren<UniButton>();
...
/*        prev.interactable = true;
    ...
    private void SetPageSelection(int aPageIndex)
    {
        ...
        {
            if (_pageSelectionImages == null) return;
    ...
    public int GetPageCurrent() { return _currentPage; }
}
